...
public class WSWSVoucher  extends WSBean  implements java.io.Serializable {
    ...
    /**
     * Gets the importKey value for this WSWSVoucher.
     * 
     * @return importKey
     */
    ...
    /**
     * Sets the importKey value for this WSWSVoucher.
     * 
     * @param importKey
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "importKey"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
